...
def main():
    ...
    if args.save_reports:
        ...
        if id_col is None:
            id_series = dataset.index.to_series().rename("row_id")
        else:
            id_series = dataset[id_col]
    ...
    if args.save_reports:
        ...
        df_champion = pd.DataFrame([
            {
                ...
                "criterio": "Mejor desempeño global"
            },
            {
                "rol": "Challenger",
                "modelo": "LogReg",
        ...
        logging.info("✅ Champion: MLP | Challenger: LogReg")
